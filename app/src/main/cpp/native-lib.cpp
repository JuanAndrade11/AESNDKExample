...
Java_com_example_aesndkexample_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
    std::string hello = "I want to encrypt this String under NDK I want to encrypt this String under NDK";
    return env->NewStringUTF(hello.c_str());
}
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_aesndkexample_MainActivity_crypt(JNIEnv *env, jclass type, jbyteArray jarray,
                                                  jlong time, jint jmode) {
